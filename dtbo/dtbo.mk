...
$(BOARD_PREBUILT_DTBOIMAGE):
	...
	$(APPEND_CERTS) --alignment 16 --cert1 $(DEVICE_PATH)/dtbo/security/$(PRODUCT_DEVICE)/cert1.der --cert2 $(DEVICE_PATH)/dtbo/security/$(PRODUCT_DEVICE)/cert2.der --dtbo $(BOARD_PREBUILT_DTBOIMAGE)
